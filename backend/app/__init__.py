...
def seed_database():
    ...
    def ensure_department(name, code):
    ...
    print("Checking initial departments and users...")

    ensure_department('Blast Furnace', 'BF')
    ensure_department('Steel Melting Shop', 'SMS')
    ensure_department('Rolling Mill', 'RM')
    ensure_department('Coke Ovens', 'CO')
    ensure_department('Safety & Environment', 'SAF')
    ensure_department('Maintenance & Utilities', 'MNT')
    db.session.commit()
    ...
    if User.query.first() is not None:
        print("Users already exist. Skipping default user seeding.")
        return

    print("Users table empty. Seeding default login accounts...")
